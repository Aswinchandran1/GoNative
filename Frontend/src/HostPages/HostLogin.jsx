  ...
  return (
    <div className='h-screen flex justify-center items-center'>
      <div className='shadow-lg shadow-black p-7 flex flex-col bg-white rounded w-[450px]' >
        ...
        <p className='text-center mt-4'>Don't have an account? <Link to={'/host-register'} className='cursor-pointer text-blue-600 hover:text-blue-500 hover:underline '>Sign up</Link ></p>
      </div>
    </div>
  )
}
